...
| customVideoEvents   | 自定义视频事件处理器                                                                                                                                                                                                           | `{ onPlay: (AudioProps: props) => void, onDownload: (src: string) => void }` |           |
| customAudioEvents   | 自定义音频事件处理器                                                                                                                                                                                                           | `{ onPlay: (AudioProps: props) => void, onDownload: (src: string) => void }` |           |
| customFileEvents    | 自定义文件事件处理器                                                                                                                                                                                                           | `{ onDownload: (src: string) => void }`                                      |           |
