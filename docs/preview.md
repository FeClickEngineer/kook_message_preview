...
| customVideoEvents   | 自定义视频事件处理器                                                                                                                                                                                                           | `{ onPlay: (VideoModule: module) => void, onDownload: (VideoModule: module) => void }` |           |
| customAudioEvents   | 自定义音频事件处理器                                                                                                                                                                                                           | `{ onPlay: (AudioModule: module) => void, onDownload: (AudioModule: module) => void }` |           |
| customFileEvents    | 自定义文件事件处理器                                                                                                                                                                                                           | `{ onDownload: (module: string) => void }`                                             |           |
| customButtonEvents  | 自定义按钮事件处理器                                                                                                                                                                                                           | `{ onClick: (module: ButtonModule) => void }`                                          |           |
| customImageEvents   | 自定义图片事件处理器                                                                                                                                                                                                           | `{ onClick: (module: ImageElement) => void }`                                          |           |